...
public class OptdigitsTest {
    ...
    private static final Double DEFAULT_COOLING_FACTOR = 0.6;

    // Change these for Genetic Algorithms
    private static final int INITIAL_POPULATION = 60;
    private static final int MATES_PER_ITERATION = 25;
    private static final int MUTATIONS_PER_ITERATION = 10;
